 ...
 const struct MQI_BY_VALUE_STR { 
  ...
  char *name;
   ...
   {         636, "MQSCO_CURRENT_LENGTH (4 byte)" },
   {         636, "MQSCO_LENGTH_6 (4 byte)" },
   {         648, "MQSCO_CURRENT_LENGTH (8 byte)" },
